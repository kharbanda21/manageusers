		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Manage Users",
									"targetURL": "#yamahaotcmanageusers-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"yamahaotcmanageusers-display": {
								"semanticObject": "yamahaotcmanageusers",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=yamaha.otc.manageusers",
									"url": sap.ui.require.toUrl("yamaha/otc/manageusers")
								}
							}
						}
					}
